...
## Basic Join
<c-lbdocs.component_example path="join/basic" />

## Vertical Join
<c-lbdocs.component_example path="join/vertical" />

## With Inputs
<c-lbdocs.component_example path="join/with-inputs" />

## API Reference
### `c-lb.join`
<c-lbdocs.api_table component_name="join" />
