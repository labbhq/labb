...
## Hero with Image
<c-lbdocs.component_example path="hero/with-image" />

## Hero with Overlay
<c-lbdocs.component_example path="hero/with-overlay" />

## API Reference
### `c-lb.hero`
<c-lbdocs.api_table component_name="hero" />

### `c-lb.hero.content`
<c-lbdocs.api_table component_name="hero.content" />

### `c-lb.hero.overlay`
<c-lbdocs.api_table component_name="hero.overlay" />
