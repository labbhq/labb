...
## Basic Divider
<c-lbdocs.component_example path="divider/basic" previewStyle="block" />

## Color Variants
<c-lbdocs.component_example path="divider/color-variants" previewStyle="block" />

## Text Position
<c-lbdocs.component_example path="divider/position" previewStyle="block" />

## Horizontal Divider
<c-lbdocs.component_example path="divider/horizontal" previewStyle="block" />

## API Reference
### `c-lb.divider`
<c-lbdocs.api_table component_name="divider" />
