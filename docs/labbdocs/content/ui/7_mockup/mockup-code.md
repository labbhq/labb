...
## Basic Code Mockup
<c-lbdocs.component_example path="mockup-code/basic"/>

## Multi-line with Colors
<c-lbdocs.component_example path="mockup-code/multi-line" />

## API Reference
### `c-lb.mockup-code`
<c-lbdocs.api_table component_name="mockup-code" />
