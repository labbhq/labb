...
## Snap to Center
<c-lbdocs.component_example path="carousel/snap-center" />

## Snap to End
<c-lbdocs.component_example path="carousel/snap-end" />

## Vertical Carousel
<c-lbdocs.component_example path="carousel/vertical" />

## Half Width Items
<c-lbdocs.component_example path="carousel/half-width" />

## With Indicator Buttons
<c-lbdocs.component_example path="carousel/with-indicators" />

## With Next/Previous Buttons
<c-lbdocs.component_example path="carousel/with-next-prev" />


## API Reference

### `c-lb.carousel`
<c-lbdocs.api_table component_name="carousel" />

### `c-lb.carousel.item`
<c-lbdocs.api_table component_name="carousel.item" />
