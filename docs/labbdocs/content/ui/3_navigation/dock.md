...
## Color Variants
<c-lbdocs.component_example path="dock/color-variants" previewStyle="block" />

## Sizes
<c-lbdocs.component_example path="dock/sizes" previewStyle="block" />

## API Reference
### `c-lb.dock`
<c-lbdocs.api_table component_name="dock" />

### `c-lb.dock.label`
<c-lbdocs.api_table component_name="dock.label" />
