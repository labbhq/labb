...
## Color Variants
<c-lbdocs.component_example path="steps/color-variants" />

## Vertical
<c-lbdocs.component_example path="steps/vertical" />

## Custom Content
<c-lbdocs.component_example path="steps/with-data-content" />

## With Icons
<c-lbdocs.component_example path="steps/with-icons" />

## API Reference
### `c-lb.steps`
<c-lbdocs.api_table component_name="steps" />

### `c-lb.steps.item`
<c-lbdocs.api_table component_name="steps.item" />
