...
This page shows different ways of using existing components to implement theme controllers. For complete theming setup and configuration, see the <a href="{% doc_url '2_concepts/2_theming.md' 'guide' %}">Theming</a> documentation.
...
For backend theme persistence, use the `c-lb.m.dependencies` component to automatically handle theme switching with Django sessions. See <a href="{% doc_url '2_concepts/2_theming.md' 'guide' %}#4-server-side-theme-persistence">theme persistence</a> for more details.
