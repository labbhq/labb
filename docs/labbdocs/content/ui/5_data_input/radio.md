...
## Color Variants
<c-lbdocs.component_example path="radio/color-variants" />

## Sizes
<c-lbdocs.component_example path="radio/sizes" />

## API Reference
### `c-lb.radio`
<c-lbdocs.api_table component_name="radio" />
