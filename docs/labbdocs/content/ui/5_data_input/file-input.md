...
## Color Variants
<c-lbdocs.component_example path="file-input/color-variants" />

## Sizes
<c-lbdocs.component_example path="file-input/sizes" />

## With Fieldset
<c-lbdocs.component_example path="file-input/with-fieldset" />

## API Reference
### `c-lb.file-input`
<c-lbdocs.api_table component_name="file-input" />
