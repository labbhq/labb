...
Any radio or checkbox component becomes a theme switcher by adding the `theme-controller` class. With server-side persistence enabled, labb posts the choice to the server for you.
